...
public class EarthquakeAdapter extends ArrayAdapter<Earthquake> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        TextView magnitudeText = (TextView) listView.findViewById(R.id.magnitude);
        ...
        TextView locationOffsetText = (TextView) listView.findViewById(R.id.location_offset);
        locationOffsetText.setText(locationOffset);

        TextView primaryLocationText = (TextView) listView.findViewById(R.id.primary_location);
        ...
        TextView timeText = (TextView) listView.findViewById(R.id.time);
